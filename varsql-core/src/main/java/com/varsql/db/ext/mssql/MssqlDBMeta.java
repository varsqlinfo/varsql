...
import com.varsql.core.db.serviceobject.ObjectTypeTabInfo;
 ...
 * @변경이력	:
 */
public class MssqlDBMeta extends DBMetaImpl{
	
	private static Logger logger = LoggerFactory.getLogger(MssqlDBMeta.class);
