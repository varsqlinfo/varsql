...
public class PostgresqlDataTypeFactory extends AbstractDataTypeFactory{
	...
	public PostgresqlDataTypeFactory() {
		...
		addDataType(new VenderDataType("json", DefaultDataType.OTHER.getTypeCode() , DBColumnMetaInfo.STRING));
		addDataType(new VenderDataType("jsonb", DefaultDataType.OTHER.getTypeCode() , DBColumnMetaInfo.STRING));
	}
}
