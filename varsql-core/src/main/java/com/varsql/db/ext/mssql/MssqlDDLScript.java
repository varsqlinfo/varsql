...
public class MssqlDDLScript extends DDLScriptImpl {
	Logger logger = LoggerFactory.getLogger(MssqlDDLScript.class);
	 ...
	 * @Method override : @see com.varsql.core.db.ddl.script.DDLScriptImpl#getSequence(com.varsql.core.db.beans.DatabaseParamInfo, java.lang.String[])
	 * @작성자   : ytkim
	 * @작성일   : 2018. 9. 19. 
	 * @변경이력  :
	 * @param dataParamInfo
