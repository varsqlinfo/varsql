...
public class OracleDataTypeFactory extends AbstractDataTypeFactory{
	...
	public OracleDataTypeFactory() {
		addDataType(new VenderDataType("TIMESTAMP WITH LOCAL TIME ZONE", DefaultDataType.TIMESTAMP_WITH_TIMEZONE.getTypeCode(), DBColumnMetaInfo.TIMESTAMP));
		addDataType(new VenderDataType("TIMESTAMP WITH TIME ZONE", DefaultDataType.TIMESTAMP_WITH_TIMEZONE.getTypeCode(), DBColumnMetaInfo.TIMESTAMP));
		addDataType(new VenderDataType("DATE", DefaultDataType.TIMESTAMP.getTypeCode(), DBColumnMetaInfo.DATE));
