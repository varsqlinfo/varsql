...
import com.vartech.common.report.ReportConstants;
...
public interface VarsqlReportConfig {
	...
	enum TABLE_COLUMN implements EnumMapperType{
		...
		NULLABLE("nullable","Nullable", 6 , ReportConstants.ALIGN.CENTER.align()),	// null 여부.
		COMMENT("comment","Comment",15), 	// 코멘트
		CONSTRAINTS("constraints","constraints",6, ReportConstants.ALIGN.CENTER.align()),	// 제약조건 여부.
		...
		TABLE_COLUMN(String key ,String name , int width){
			this(key , name , width , ReportConstants.ALIGN.LEFT.align());
		}
