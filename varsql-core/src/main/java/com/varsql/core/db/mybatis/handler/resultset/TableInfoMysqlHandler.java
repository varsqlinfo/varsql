...
public class TableInfoMysqlHandler implements ResultHandler<DataMap> {
	...
	public TableInfoMysqlHandler(DataTypeFactory dataTypeFactory){
		this.dataTypeFactory = dataTypeFactory;
		this.tableInfoList = new ArrayList<TableInfo>();
		this.useTableIndex = false;
	}

	public TableInfoMysqlHandler(DataTypeFactory dataTypeFactory, List<TableInfo> tableInfoList){
		this.dataTypeFactory = dataTypeFactory;
