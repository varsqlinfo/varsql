...
public abstract class DataTypeImpl implements DataType{
...

	{
		...
		put("4", new  DataTypeInfo("INTEGER", true, false, false, VarSqlDbDataType.NUMBER));
		put("INTEGER", get("4"));
		put("INT", DataTypeInfo.copyDataTypeInfo(get("4"), "INT"));
		...
		put("DATETIME", DataTypeInfo.copyDataTypeInfo(get("91"), "DATETIME"));
		/**
		 * binary 형
		 */
