...
+function ($) {
	  ...
	  Dropdown.prototype.clearMenus= function (e) {
	    ...
	    var parentObj = $(tmptarget).closest('.header-dropdown-menu');
	  ...
	  Dropdown.prototype.toggle = function (e) {
	    ...
	    if (!isActive) {
	      if ('ontouchstart' in document.documentElement && !$parent.closest('.navbar-nav').length) {
	        // if mobile we use a backdrop because click events don't delegate
	        $(document.createElement('div'))
	          .addClass('header-dropdown-backdrop')
	          .insertAfter($(this))
	          .on('click', _this.clearMenus)
	      }
	  ...
	  Dropdown.prototype.keydown = function (e) {
	    ...
	    var desc = ' li:not(.disabled):visible a'
	    var $items = $parent.find('.header-dropdown-menu' + desc)
	  ...
	  var old = $.fn.headerDropdown

	  $.fn.headerDropdown             = Plugin
	  $.fn.headerDropdown.Constructor = Dropdown


	  // DROPDOWN NO CONFLICT
	  // ====================

	  $.fn.headerDropdown.noConflict = function () {
	    $.fn.headerDropdown = headerDropdown
	    return this
	  }
	  // APPLY TO STANDARD DROPDOWN ELEMENTS
	  // ===================================
	  ...
	  $(document)
	    .on('click.bs.header-dropdown.data-api', Dropdown.prototype.clearMenus)
	    .on('click.bs.header-dropdown.data-api', '.header-dropdown-submenu >:not(.header-menu-item)', function (e) {
	    	var subParent = $(this).closest('.header-dropdown-submenu');
	    	
	    	subParent.siblings('.header-dropdown-submenu').each(function (){
	    		var tmpEle =$(this); 
	    		if(tmpEle !=subParent){
	    			tmpEle.removeClass('open');
	    		}
	    	})
	    ...
	    .on('keydown.bs.header-dropdown.data-api', toggle, Dropdown.prototype.keydown)
	    .on('keydown.bs.header-dropdown.data-api', '.header-dropdown-menu', Dropdown.prototype.keydown)
