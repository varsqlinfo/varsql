...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><spring:message code="manager.menu.databackgmgmt"/></h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="row display-off" id="varsqlVueArea">
				...
				<div class="table-responsive">
					<div id="dataTables-example_wrapper"
						...
						<table
							...
							<thead>
								<tr role="row">
									<th class="text-center"><spring:message	code="manager.databackupmgmt.connection" text="Connection"/></th>
									<th class="text-center"><spring:message	code="manager.databackupmgmt.jobname" text="Job Name" /></th>
									<th class="text-center"><spring:message	code="manager.databackupmgmt.expression" text="Expression" /></th>
							...
							<tbody class="dataTableContent">
								<tr v-for="(item,index) in gridData" class="gradeA cursor-pointer" :class="(index%2==0?'add':'even')">
									...
									<td>
										<div><button class="btn btn-sm btn-default" @click="jobCtrl(item, 'RUN')">Run</button></div>
										<div>
	...
	<div class="col-lg-6" >
		<div class="panel panel-default detail_area_wrapper" >
			<div class="panel-heading"><spring:message code="manager.databackupmgmt.form.header" text="Job 관리"/><span style="margin-left:10px;font-weight:bold;">{{detailItem.jobName}}</span></div>
				...
				<form id="addForm" name="addForm" class="form-horizontal" onsubmit="return false;">
					<div class="view-area" :class="viewMode=='form'?'on':''">
						<div class="form-group" :class="errors.has('NAME') ? 'has-error' :''">
							<label class="col-sm-3 control-label"><spring:message code="manager.databackupmgmt.jobname"  /></label>
							<div class="col-sm-9">
						...
						<div class="form-group" :class="errors.has('EXPRESSION') ? 'has-error' :''">
							<label class="col-sm-3 control-label"><spring:message code="manager.databackupmgmt.expression"  /></label>
							<div class="col-sm-9">
						...
						<div class="form-group" :class="errors.has('NAME') ? 'has-error' :''">
							...
							<div class="col-sm-9">
								...
								<div class="margin-bottom5">
									<label><spring:message code="manager.databackupmgmt.connection"  /></label>
									<div>
...
VarsqlAPP.vueServiceBean( {
	...
	,data: {
		...
		,typeList : [{name :'Cron', type:'cron'}, {name :'Simple', type:'simple'}]
		,selectObj : {}
		,historyItem : {}
	}
	,methods:{
			...
			this.$validator.validateAll().then(function (result){
				if(result){
					...
					if(VARSQL.isBlank(item.vconnid)){
						VARSQLUI.toast.open(VARSQL.messageFormat('item.select.message', '<spring:message code="manager.databackupmgmt.connection"  />'));
						return ;
					}
