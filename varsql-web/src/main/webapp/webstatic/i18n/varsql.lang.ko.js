...
VARSQL_LANG = {
	...
	,'varsql.0036' : '댓글이 삭제되면 복구할 수 없습니다. 그래도 삭제하시겠습니까?'
	,'varsql.0036' : '댓글이 삭제되면 복구할 수 없습니다. 그래도 삭제하시겠습니까?'
	,'varsql.0037' : '게시글이 삭제되면 복구할 수 없습니다. 그래도 삭제하시겠습니까?'
	,'varsql.0038' : '제목을 입력 하세요.'
	,'varsql.0039' : '테이블명을 입력해주세요.'
	,'varsql.0040' : '컬럼 정보를 입력해주세요.'
	,'varsql.0041' : '테이블을 생성하시겠습니까?'
	,'varsql.0042' : '필수 입력사항입니다.'
	,'varsql.0043' : '사이즈는 {size} 사이여야 합니다'
	,'varsql.0044' : '존재하는 이메일 입니다.'
	,'varsql.0045' : '아이디와 달라야 합니다.'
	,'varsql.0046' : '비밀번호가 같아야합니다.'
	,'varsql.0047' : '최소 {size}글자 이상 이여야 합니다'
	,'varsql.0049' : '아이디 중복 입니다.'
	,'varsql.0050' : 'CapsLock이 켜져 있습니다'
	,'varsql.0051' : '유효하지않은 Email입니다.'
	,'varsql.0052' : '유효하지 않은 토근입니다.'
	,'varsql.0053' : '패스워드를 정확히 입력해주세요.'
	,'varsql.0054' : '변경되었습니다.'
	,'varsql.0055' : '적용되었습니다.'
	...
	,'varsql.a.0005' : '[풀 초기화]를 해야 적용 됩니다.'
